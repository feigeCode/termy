...
define_root_settings! {
    ...
    (AgentSidebarEnabled, "agent_sidebar_enabled", [], Tabs, "AGENTS", "Agent Sidebar", "Enable the persisted agent projects and threads sidebar", ["agent", "agents", "sidebar", "threads", "projects", "cmux", "ai"], RootSettingValueKind::Boolean, false),
    (AgentSidebarWidth, "agent_sidebar_width", [], Tabs, "AGENTS", "Agent Sidebar Width", "Width for the agent sidebar in pixels", ["agent", "agents", "sidebar", "width"], RootSettingValueKind::Numeric, false),
