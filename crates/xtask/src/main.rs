...
fn render_configuration_doc() -> String {
    ...
    output.push_str("Platform note: the Agent Sidebar/Workspace is currently unavailable on Windows builds.\n\n");
...
mod tests {
    ...
    fn configuration_doc_mentions_runtime_tmux_session_hub() {
        ...
        assert!(out.contains("currently unavailable on Windows builds"));
    }
